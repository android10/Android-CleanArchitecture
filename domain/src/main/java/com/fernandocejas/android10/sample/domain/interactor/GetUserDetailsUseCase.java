 ...
 */
public class GetUserDetailsUseCase implements GetUserDetailsUseCase {
   ...
   */
  @Inject
  public GetUserDetailsUseCase(UserRepository userRepository, ThreadExecutor threadExecutor,
  ...
  private static class GetUserDetailsSubscriber extends UseCaseSubscriber<User> {
